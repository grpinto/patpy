"""Smoke tests for the patpy-analysis-mcp CLI and tool registry.
...
def test_server_metadata() -> None:
    ...
    assert mcp.name == "patpy-analysis-mcp"


def test_all_expected_tools_registered() -> None:
    """Importing ``patpy_analysis_mcp.main`` must register the full tool surface."""
...
def test_cli_version_flag_exits_zero() -> None:
    """``patpy-analysis-mcp --version`` should print the version and exit 0."""
